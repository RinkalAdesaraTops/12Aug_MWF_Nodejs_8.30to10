...
import { add, deleteuser,updateUser } from './reduxtoolkit/UserDataReducer'
...
return(
  <tr>
          ...
          <td>{i.name}</td>
          <td>{i.age}</td>
          <td><button onClick={()=>edituser(i.id)}>Edit</button><button onClick={()=>dispatch(deleteuser(i.id))}>Delete</button></td>
        </tr>
)
          })
        }
